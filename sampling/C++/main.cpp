...
int main(int argc, const char* argv[]) {
	...
	char *graph_name = "C:/Users/Sylvon/CS224W/project/Email-Enron.txt";
	...
	int sample_percents[] = {95};
	//int sample_percents[] = {90, 95};
	char file_path[1024];
	char percent_dir[1024];
	char *output_dir = "samples/";
	RandomWalk rw(g, 500, 500*0.3);
	time_t start, end;
	for (int p = 0; p < sizeof(sample_percents)/sizeof(int); p++) {
		time(&start);
